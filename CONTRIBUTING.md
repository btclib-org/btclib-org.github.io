...
A GitHub Pages site and nothing else. `index.md` is the homepage and it
is **generated**: `.github/scripts/derive-homepage.sh` writes it from
`btclib-org/.github`'s `profile/README.md`, which is the organization's
...
```shell
sha=$(git ls-remote https://github.com/btclib-org/.github main | cut -f1)
...
hand* a refusal rather than a convention. `website.yml` answers whether
